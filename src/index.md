...
@zhou-etal-2024-multimodal extend this bidirectional ST-GCN approach with a per-channel Gating module that filters out non-informative frames and an auxiliary multimodal transformer branch fusing skeleton and handshape features for temporal localization of sign start and end frames, achieving 80.8% Top-1 / 95.2% Top-5 accuracy on combined WLASL, ASLLVD, RIT, and DSP citation-form datasets.
